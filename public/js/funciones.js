...
// A mettre ici les fonctions pour changer les couleurs de fond selon les pages sur lesquelles je suis


//ejercicio 3 del sprint NO ANDA MAS SNIFF
  var counter = 0;
  function add(){
    return counter += 1;
  }
  ...
  function myFunction(){
    document.getElementById("contar").innerHTML = add();
  }
